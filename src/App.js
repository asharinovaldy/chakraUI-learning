      ...
      <VStack>
        <Container maxW="container.xl">
          ...
          <Flex justifyContent="start" gap={'3'}>
            <CardMerchant
              merchant="Nasgor Tiarbah"
              time="10:00 - 22:00 WITA"
              totalMenu="15"
              location="Gunung Telihan"
            />
            <CardMerchant
              merchant="Geprek Legenda"
              time="10:00 - 22:00 WITA"
              totalMenu="25"
              location="Satimpo"
            />
          ...
          <Flex justifyContent="start" gap={'3'}>
            <Product
              productImage="https://borneos.link/OBLd0qF	"
              productName="Spicy Noodle"
              productPrice="Rp. 20.000"
            />
            <Product
              productImage="https://borneos.link/RqK8ik3"
